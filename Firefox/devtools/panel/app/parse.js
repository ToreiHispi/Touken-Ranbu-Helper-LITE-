(function(exports) {
        ...
        switch (n['type']) {
          case 'equip':
            ...
            _this.sendMessage({
              type: 'notify',
              message: {
                title: (exports.tohken.define.tohkens[n['sword']] ? exports.tohken.define.tohkens[n['sword']]['name'] : n['sword']) + "'s troops just fell!",
                message: "Pay attention to damage, your swords might break!",
                context: "Notification can be set in Settings."
              }
            });
            break;
          case 'broken':
            switch (n['value']) {
              case 0:
                ...
                _this.sendMessage({
                  type: 'notify',
                  message: {
                    title: (exports.tohken.define.tohkens[n['sword']] ? exports.tohken.define.tohkens[n['sword']]['name'] : n['sword']) + " lost some blood!",
                    message: "Pay attention to damage, your swords might break!",
                    context: "Notification can be set in Settings."
                  }
                });
              ...
              case 1:
                ...
                _this.sendMessage({
                  type: 'notify',
                  message: {
                    title: (exports.tohken.define.tohkens[n['sword']] ? exports.tohken.define.tohkens[n['sword']]['name'] : n['sword']) + " is lightly bruised!",
                    message: "Pay attention to damage, your swords might break!",
                    context: "Notification can be set in Settings."
                  }
                });
              ...
              case 2:
                ...
                _this.sendMessage({
                  type: 'notify',
                  message: {
                    title: (exports.tohken.define.tohkens[n['sword']] ? exports.tohken.define.tohkens[n['sword']]['name'] : n['sword']) + " is moderately injured!",
                    message: "Pay attention to damage, your swords might break!",
                    context: "Notification can be set in Settings."
                  }
                });
              ...
              case 3:
                ...
                _this.sendMessage({
                  type: 'notify',
                  message: {
                    title: (exports.tohken.define.tohkens[n['sword']] ? exports.tohken.define.tohkens[n['sword']]['name'] : n['sword']) + " is severely wounded!",
                    message: "Pay attention to damage, your swords might break!",
                    context: "Notification can be set in Settings."
                  }
                });
    ...
    _.forEach(party, (function(_this) {
      return function(v, k) {
        ...
        if (f !== null) {
          ...
          fd.setTime(finish);
          earlier = 0;
          title = v['party_name'] + "Party";
          message = "Expedition will end at " + (fd.getHours()) + ":" + (fd.getMinutes()) + ":" + (fd.getSeconds());
          context = "Receive expedition rewards.";
          cmsg = "Notification can be set in Settings.";
          switch (_this.config['notify_conquest']) {
            case 0:
              return;
            case 1:
              title = v['party_name'] + " 's expedtion will end in 5 minutes.";
              cmsg = "Notification can be set in Settings.";
              earlier = 5 * 60 * 1000;
              break;
            case 2:
              title = v['party_name'] + " 's expedition will end in 2 minutes.";
              cmsg = "Notification can be set in Settings.";
              earlier = 2 * 60 * 1000;
              break;
            case 3:
              title = v['party_name'] + " 's expedition will end in 30 seconds.";
              cmsg = "Notification can be set in Settings.";
              earlier = 0.5 * 60 * 1000;
          }
          _this.sendMessage({
            ...
            'startmsg': {
              'title': v['party_name'] + " are going on an expedition.",
              'message': message,
              'context': cmsg
            }
          });
  ...
  exports.tohken.parse.check_repair = function(repair) {
    ...
    _.forEach(repair, (function(_this) {
      return function(v, k) {
        var context, earlier, w, f, fd, finish, message, title;
        console.log(v);
        f = v['finished_at'];
        ...
        if (f !== null) {
          ...
          fd.setTime(finish);
          earlier = 0;
          title = (exports.tohken.define.tohkens[w['sword_id']] ? exports.tohken.define.tohkens[w['sword_id']]['name'] : w['sword_serial_id']) + "'s just been repaired!";
          message = "Repair ended at " + (_this.t2t(fd));
          context = "Go and bring your sword home!";
          switch (_this.config['notify_repair']) {
            case 0:
              return;
            case 1:
              title = (exports.tohken.define.tohkens[w['sword_id']] ? exports.tohken.define.tohkens[w['sword_id']]['name'] : w['sword_serial_id']) + " will be fixed in 5 minutes.";
              cmsg = "Notification can be set in Settings.";
              earlier = 5 * 60 * 1000;
              break;
            case 2:
              title = (exports.tohken.define.tohkens[w['sword_id']] ? exports.tohken.define.tohkens[w['sword_id']]['name'] : w['sword_serial_id']) + " will be fixed in 2 minutes.";
              cmsg = "Notification can be set in Settings.";
              earlier = 2 * 60 * 1000;
              break;
            case 3:
              title = (exports.tohken.define.tohkens[w['sword_id']] ? exports.tohken.define.tohkens[w['sword_id']]['name'] : w['sword_serial_id']) + " will be fixed in 30 seconds.";
              cmsg = "Notification can be set in Settings.";
              earlier = 0.5 * 60 * 1000;
          }
          _this.sendMessage({
            'type': 'alarm',
            'time': finish - earlier,
            'id': "repair-" + (exports.tohken.define.tohkens[w['sword_id']] ? exports.tohken.define.tohkens[w['sword_id']]['name'] : w['sword_serial_id']) + "-" + finish,
            'message': {
              'title': title,
              'message': message,
              'context': context
            ...
            'startmsg': {
              'title': (exports.tohken.define.tohkens[w['sword_id']] ? exports.tohken.define.tohkens[w['sword_id']]['name'] : w['sword_serial_id']) + " is now being repaired.",
              'message': "Repair will end at " + (_this.t2t(fd)),
              'context': "Notification can be set in Settings."
            }
          });
        }
